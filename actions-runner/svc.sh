...
SVC_NAME="actions.runner.apoudatta-CICD-assignment-2.MacBooks-MacBook-Air"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (apoudatta-CICD-assignment-2.MacBooks-MacBook-Air)"
